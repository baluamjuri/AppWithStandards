 ...
 * not existed. The first parameter should be userId and second parameter should be
...
public class DeleteRoleFromUserValidator implements ConstraintValidator<DeleteRoleFromUserValidation, Object[]> {
